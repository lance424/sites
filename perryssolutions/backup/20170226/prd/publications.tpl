...
<?php
$pdflink_file = 'publications/Systematic Innovation - Innovators and Entrepreneurs of Minneapolis 2016-Perrys Solutions.pdf';
$pdflink_desc = 'Systematic Innovation';
include($php_root_dir . 'templates/pdflink.tpl');
?>
 (2016 Innovators and Entrepreneurs of Minneapolis Meet Up Group)
