...
?>
        ...
        <p>DESIGN EXPERT V10
        <br>Design Expert has a few new items that are worth highlighting for users. Any "ignored" data is now highlighted while graphing. Side by side interpretation graphs are also now available. Cut and paste features have been improved. In the more advanced category, a new tool has been added called Definitive Screening Designs. This is not a valuable or needed tool. There is also a new Design Wizard. It may give you another tool option, but you better have a good idea first.

        <p>VALUABLE TRAINING COMPONENTS
        <br>There are 5 core areas to include with any training program. This includes items to Remember, Understand, Apply, Evaluate and Create. Balancing these areas properly makes an effective experience.

        <p>SYSTEMATIC INNOVATION
        <br>Last fall I was asked to lead a Systematic Innovation discussion. It started by defining the phrase! It applies to how we make decisions in all business areas, not just R&D. While innovation tools can be helpful, it is beyond that. Systematic processes can help, but it starts with how we think about our own ideas. Where could you <a href="http://bit.ly/2lbWp0r"target="_blank">benefit most?</a>

        <p>

<?php
$pdflink_file = 'publications/Newsletter 11-16 - Perrys Solutions.pdf';
$pdflink_desc = 'November 2016';
include($php_root_dir . 'templates/pdflink.tpl');
?>

        <p>DECISION MAKING - CULTURE
        <br>In the book, "How Leaders Think," they discuss 4 frames for making organizational decisions. The next topic is culture. Each organization, department and group is unique. How we decide needs to consider the norms of the organization so the decision can be best accepted. Develop and share a hopeful vision, while still respecting the history of the organization. Lead by example and tell stories to reward and demonstrate this vision.

        <p>MINITAB V17
        <br>Previously in Minitab, outlier checks were limited to the Box Plot on raw data. Now the Grubbs and Dixon tests are available, but are weak if there is more than one potential outlier. The bubble plot is an interesting new addition! Response Optimizer can now include constraints for input variables. The Two-Way ANOVA has been removed, which I used for training. The Assistant feature has been expanded (prove to yourself that you trust it though, I have not confirmed all of the math is correct). Otherwise, most changes are process related. While helpful, not going to greatly change your capabilities.

        <p>KNOWLEDGE BASED DECISIONS - VIDEO
        <br>In recent years, our approach to basic statistical training includes a discussion of the decision making process on the first day. Providing tools without a framework for "thinking" is very limiting. In my opinion, we use data to create knowledge or understanding. Then we balance the new knowledge with existing knowledge and the other considerations we have in our <a href="http://bit.ly/1KSZA3A"target="_blank">decision making process.</a>

        <p>

<?php
$pdflink_file = 'publications/Newsletter 8-16 - Perrys Solutions.pdf';
$pdflink_desc = 'August 2016';
include($php_root_dir . 'templates/pdflink.tpl');
?>

        <p>DECISION MAKING - POLITICS
        <br>In the book, "How Leaders Think," they discuss 4 frames for organizational decisions. The next one is politics. Who has the power and the interest to support what decision you are making. Who can provide the resources. Clarify what they want versus what they can get.

        <p>ROBUST DESIGN - SET NOMINALS WHERE INSENSITIVE
        <br>Continuing with the robust design series, this time we focus on setting nominal values. There are areas that behave better than others. With just a little change, do we fall off of a cliff? <a href="http://bit.ly/1jleFNp"target="_blank">Monte Carlo Analysis</a> can help us identify these danger spots, and help direct us to better performing areas.

        <p>PROJECT MANAGEMENT - DOING MORE WITH LESS
        <br>The pressure always exists to increase performance. Yet, to do it with less. Who of us has not already used the best techniques and tools to save time? I think it relates to <a href="http://bit.ly/10qWaF3"target="_blank">decision making</a> / <a href="http://bit.ly/1P22uHs"target="_blank">motivation</a>, <a href="http://bit.ly/1SYvwIp"target="_blank">requirements</a> / <a href="http://bit.ly/17q0y7g"target="_blank">risk</a>, and finding uncommon but <a href="http://bit.ly/2b17KM6"target="_blank">useful tools.</a> However, we also need to understand the cost benefit of doing this.
