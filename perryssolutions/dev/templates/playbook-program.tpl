      <td rowspan="3" valign="top">
        ...
        <p>We have achieved development "speed records" in a number of industries, on significant and complex projects while in various management positions. This is "big picture" speed which means we are getting to market or getting to approval. We are not just finishing a task and putting in on the shelf. This is accomplished within budget.
...
?>
        ...
        <p>We bring a <a href="<?php echo ${env} ?>publications/Program Management-Perrys Solutions.pdf" target="_blank">systems perspective</a> right from the beginning of a project. Requirements are an important part of creating the desired outcome. Intent, interpretation and ingenuity are important characteristics to perform this work. Studies show that 70% of projects fail because of poor requirements. Requirement generation is an evolving series of steps that involves needs, requirements, regulations, and constraints.
        <p>Risk management is another critical area for success. We have resolved the highest risk on a billion dollar government program.  We have provided workshops to help others understand and resolve their own risks. What track record do we have? If we are successful, then nothing challenging happens. This is great news! If set backs happen that does not mean we failed. We need to identify them early, while the impacts are still reasonably small. The goal is to come to this conclusion as quick as possible. This is what makes the speed records possible.
        <p>Program management related areas beyond requirements generation and risk management include earned value methods, parametric cost estimating, scheduling, budgeting, critical path and PERT analysis, project execution, project reporting, and contingency planning. These are all experience areas we can bring to your project.
         <p>We are familiar with new product development processes from DoD, FDA (cGMP), FAA, auto (APQP), DFSS, Toyota, Phase/ Gate, Agile, and more. These are really just a series of problem solving activities and status reviews based on the priorities and risks involved. We have improved the New Product Development process and related business processes in multiple industries so understand the unique nature of the solutions required.
