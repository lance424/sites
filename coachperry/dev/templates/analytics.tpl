    <div class="col1">
      <h1>Analytics</h1>
        ...
        <p>Basketball analytics has been a topic of growing interest. Years ago, finding a box score and knowing points scored, free throws made and rebounding results was satisfactory. Creating a shot chart during games would allow a quick look at how your offense and defense was performing. (I did this with my own elementary age teams that I was coaching.)
...
But we also have a lot of "useless stats." Decent ideas and concepts, but they break down in implementation. Further, there are areas that are still completely broken. For example, individual defense player ranking. My research has shown that most evaluations are at the team level. This is a high level metric and is also impacted by who is on the court with you. Some basketball analysts have taken a deeper dive, but it requires a "PhD in Basketball" to perform the analysis, and it is still highly questionable.
        ...
        <p><a href="http://www.sctimes.com/story/sports/high-school/2014/11/17/area-notebook-brinker-shines-huskers/19206391/?ID=127"target="_blank">New Coach</a> - St. Cloud Times article about prior position at St. Cloud Christian High School
        <p>

        <p>Below is a link to our coaching resume. It provides more specifics about his experiences as they relate to basketball. </a></p>
...
<?php
$pdflink_file = 'docs/Resume - Perry Parendo - Web.pdf';
$pdflink_desc = 'Resume';
